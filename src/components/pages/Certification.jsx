...
const Certification = () => {
  return (
    <div className="max-w-screen-2xl  mx-auto container md:px-20  bg-gray-100 text-gray-800">
      
      {/* Main Content */}
      <main className="container mx-auto p-6">
        <h1 className='text-5xl pt-10 pb-10 flex justify-center items-center'>Certifications</h1>
        <section className="p-6 rounded-lg shadow-md">
          ...
          <a href="/">
        <button className="mt-5 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-lg transition duration-300 ease-in-out">
          Back to Home
        </button>
      </a>
        </section>
      ...
      <footer className="bg-gray-800 text-white p-4">
        <div className="container mx-auto text-center">
          <p>&copy; 2024 My colorlib. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
